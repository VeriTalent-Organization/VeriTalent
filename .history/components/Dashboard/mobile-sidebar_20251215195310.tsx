...
export default function Sidebar() {
  ...
  const menuItems = menuItemsByRole[mockUser.user_type] || [];
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">
            {roleLabels[mockUser.user_type]}
          </div>
          <div className="font-semibold text-gray-900 mb-0.5">{mockUser.full_name}</div>
