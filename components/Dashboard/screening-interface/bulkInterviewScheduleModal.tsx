...
export default function BulkInterviewScheduleCompact({ onClose }: BulkInterviewScheduleCompactProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 bg-opacity-50 flex items-end justify-center p-4 z-[10000]">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-full sm:max-w-3xl max-h-[100dvh] overflow-y-auto">
        {/* Header */}
