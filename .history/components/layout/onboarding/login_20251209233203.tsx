        ...
        <div className=" ">
          ...
          <div className="space-y-4">
            <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-300 rounded-xl hover:bg-gray-50 transition font-medium text-gray-700">
              <Image src={Icons.google} alt="google icon" height={20} width={20}/>
              Login with Google
            </button>

            <button className="w-full flex items-center justify-center gap-3 py-4 border border-gray-300 rounded-xl hover:bg-gray-20 transition font-medium text-gray-700">
              <Image src={Icons.linkedin} alt="linkedln" height={20} width={20}/>
              Login with LinkedIn
            </button>
